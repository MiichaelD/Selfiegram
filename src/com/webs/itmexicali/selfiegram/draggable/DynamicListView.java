...
package com.webs.itmexicali.selfiegram.draggable;
...
import com.webs.itmexicali.selfiegram.CustomArrayAdapter;
...
public class DynamicListView extends ListView {
    ...
    private void updateNeighborViewsForID(long itemID) {
        ...
        CustomArrayAdapter adapter = ((CustomArrayAdapter)getAdapter());
    ...
    private void handleCellSwitch() {
        ...
        if (isBelow || isAbove) {
            ...
            CustomArrayAdapter adapt = ((CustomArrayAdapter) getAdapter());
            adapt.swap(originalItem, getPositionForView(switchView));
